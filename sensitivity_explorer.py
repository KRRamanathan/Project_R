"""Live sensitivity. Same functions as the pipeline. Onboarding + airport on one page."""
...
c3.metric(
    "Of airport unfulfilled in 21:00–03:59",
    f"{100 * hourly['night_share_of_airport_unf']:.0f}%",
)
